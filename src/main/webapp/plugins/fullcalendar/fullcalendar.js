...
fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
	...
	if ($.datepicker) {
		...
		// O FullCalendar e o MomentJS usam códigos de idioma como "pt-br", mas o Datepicker
		// pode usar "pt-BR" ou, se não tiver o idioma, talvez apenas "pt".
		// Make an alias so the language can be referenced either way.
		$.datepicker.regional[dpLangCode] =
			$.datepicker.regional[langCode] = // alias
				dpOptions;

		// Alias 'en' para os dados do idioma padrão. Faça isso sempre.
